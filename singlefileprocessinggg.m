%single import and processing file
%function for importing csv file 
pathh1='C:/Users/User/Desktop/thesis coding/data for stress strain/ola ta dedomena merged FR/Specimen_RawData_2';
plinconstant=100;
%--------------------------------------------------------------------------
...
for j=2:pieceslin
    ...
    if (b<=partslin(1))% if (j<pieceslin)
       ...
       % karray(j)=stress(a:b)\strain1(a:b);%remove after
    elseif(b>partslin(1))
        b=partslin(1);
...
%--------inverse refference
strain1a(1)=0;
strain1a(2:newsizz)=strain1(1:(newsizz-1));
%----
...
strain2a(1)=0;
strain2a(2)=0;
strain2a(3:newsizz)=strain1(1:(newsizz-2));
%-----------------------------------------------------------------------------
