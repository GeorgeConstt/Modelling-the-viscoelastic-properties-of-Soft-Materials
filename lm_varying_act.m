%Trainlm with varying activation functions
%constant number of layers and neurons
...
neuralnetsdtaa1=cell(4,1);
neuralnettrrrrr=cell(4,1);
neuralneterror1=cell(4,1);
