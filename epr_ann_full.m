...
%--------------------------------------------------------------------------
%script for training networks using EPR data
%Brnn algorithm
%two hidden layers
%[50 20]
...
path1='C:/Users/User/Desktop/thesis coding/data for stress strain/ola ta dedomena merged EPR/Specimen_RawData_';
nn=23;%number of csv files in fr folder
sizesss=zeros(1,nn);
for k=1:nn
